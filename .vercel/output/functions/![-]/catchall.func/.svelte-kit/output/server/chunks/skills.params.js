...
const a = (name, extension, dark) => `${CDN_URL}/${name}/${name}-${extension}`;
const Assets = {
	// Core Languages
...
const MY_SKILLS = SKILLS.items;
const getSkills = (...slugs) => MY_SKILLS.filter((it) => slugs.includes(it.slug));
export { MY_SKILLS as M, SKILLS as S, getSkills as a, getAssetURL as g, theme as t };

...
const MY_PROJECTS: Array<Project> = [
	...
	},
	{
		...
		skills: getSkills('c', 'c++', 'aws', 'spi', 'i2c', 'embedded', 'iot', 'security', 'cloud-integration'),
	...
	},
	{
		...
		skills: getSkills('js', 'css', 'reactnative', 'blockchain', 'graphql', 'mobile-application', 'open-source'),
		type: 'Blockchain'
	},
	{
		...
		skills: getSkills('cpp', 'python', 'opencv', 'embedded', 'hardware', 'computer-vision', 'hardware-design'),
	...
	},
	{
		...
		shortDescription: 'Recipe suggestion app using OCR to scan grocery receipts and suggest recipes.',
		links: [],
		logo: khao,
		name: 'KHAO',
		period: {
	...
	},
	{
		...
		skills: getSkills('cpp', 'matlab', 'python', 'iot', 'data-analysis', 'medical-applications', 'embedded-systems'),
	...
	},
	{
		...
		shortDescription: 'Complete audio system with signal processing and audio following capabilities.',
		links: [],
		logo: '',
	...
	},
	{
		...
		shortDescription: 'Built an educational app to help 12th-grade students access study materials easily during the COVID-19 pandemic.',
		links: [
	...
	},
	{
		...
		shortDescription: 'Anonymous chat app allowing users to connect and chat with random users instantly.',
		links: [],
		logo: chatasap,
		name: 'ChatASAP',
		period: {
	...
	},
	{
		...
		color: '#4a90e2',
		description: "My portfolio website represents my journey in web development, showcasing my skills and projects. Built with SvelteKit and TypeScript, it features a modern, responsive design with dark/light mode support. The most interesting aspect was implementing the Spotify Now Playing integration, which required careful consideration of API authentication and real-time updates. The project also includes a blog section with markdown support and a project showcase that highlights my diverse range of work.",
	...
	},
	{
		...
		color: '#32cd32',
		description: "The RPI Pico Controller project was my first experience with the Raspberry Pi Pico. Using Python, I developed a controller system that integrated hardware control, sensor integration, and data processing. The project taught me about embedded systems programming and the capabilities of the Raspberry Pi Pico platform.",
	...
	},
	{
		...
		color: '#ff4500',
		description: "The OpenAI Debugger is a development tool I created to improve debugging capabilities while working with the OpenAI API. Built with Python, the tool provides comprehensive API debugging, error handling, and response analysis features. The project was born from my need for better debugging tools while working with the OpenAI API.",
	...
	},
	{
		slug: 'pdf-reader-llm',
		color: '#8b008b',
		description: "The PDF Reader Pathway LLM project combines document processing with LLM capabilities. Using Python, I developed a system that processes PDFs, extracts text, and performs LLM analysis. The most challenging aspect was implementing efficient PDF processing and text extraction while maintaining accuracy.",
	...
	},
	{
		slug: 'posefinder',
		color: '#ff69b4',
		description: "PoseFinder is a computer vision application for pose detection. Built with Python and OpenCV, the project focuses on real-time pose detection and analysis. The most interesting aspect was implementing efficient real-time processing while maintaining accuracy in pose detection.",
	...
	},
	{
		slug: 'ocr-testing',
		color: '#20b2aa',
		description: "The OCR Testing project is a testing framework for OCR functionality. Built with Python, the project focuses on ensuring the reliability of OCR systems through comprehensive testing, performance analysis, and error detection.",
